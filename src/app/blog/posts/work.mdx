...
You can create, edit and delete projects by adding, modifying or removing `*.mdx` files in the `src/app/project/projects` directory.
...
---`,
        language: "tsx",
        label: "src/app/project/projects/project-1.mdx"
      }
    ]}
/>
